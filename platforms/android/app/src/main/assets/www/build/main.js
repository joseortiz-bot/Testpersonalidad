...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_api__ = __webpack_require__(96);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__test_test__ = __webpack_require__(308);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_3__test_test__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__user_user__ = __webpack_require__(309);
...
var FirstRunPage = 'InitPage';
// The main page the user will see as they use the app over a long period of time.
// Change this if not using tabs
var MainPage = 'QuestionsPage';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ngx_translate_core__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ngx_translate_http_loader__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ionic_angular__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__mocks_providers_items__ = __webpack_require__(184);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers__ = __webpack_require__(120);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__providers__["d" /* Test */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_storage__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_api__ = __webpack_require__(96);
...
var Test = /** @class */ (function () {
    function Test(storage, api) {
        this.storage = storage;
        this.api = api;
    }
    Test.prototype.retrieve = function (request) {
        var seq = this.api.post('test', request).share();
    ...
    Test.prototype.answer = function (request) {
        var seq = this.api.post('answer', request).share();
        seq.subscribe(function (response) {
        }, function (err) {
            console.error('ERROR', err);
        });
    ...
    Test.prototype.result = function (request) {
        var seq = this.api.post('result', request).share();
        seq.subscribe(function (response) {
        }, function (err) {
            console.error('ERROR', err);
        });
...
var User = /** @class */ (function () {
    ...
    User.prototype.recovery = function (accountInfo) {
        var seq = this.api.post('recovery', accountInfo).share();
        seq.subscribe(function (res) {
            if (res.status == 'success') {
                console.info('INFO', res.status);
            }
            else {
            }
        }, function (err) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages__ = __webpack_require__(225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers__ = __webpack_require__(120);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    function MyApp(translate, platform, settings, config, statusBar, splashScreen) {
        ...
        this.pages = [
            ...
            { title: 'Questions', component: 'Questionsage' },
...
var Api = /** @class */ (function () {
    function Api(http) {
        this.http = http;
        /* url: string = 'http://192.168.1.12:8080/napps/rest'; */
        this.url = 'https://www.napps.cl/napps/rest';
    }
